...
import type { AdminUser, AdminUserCreatePayload, AdminUserUpdatePayload } from '@admin/types/adminUser';
import type { Role } from '@admin/types/role';
import type { PaginatedAdminUsersResponse } from '@admin/services/adminUserService'; // Import specific response type
